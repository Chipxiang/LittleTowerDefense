...
public class ShockTowerBlockCollection : MonoBehaviour
{
    private static Object _ShockTowerBlockPrefab;
    ...
    internal void Start()
    {
        ...
        _ShockTowerBlockPrefab = Resources.Load("ShockTowerBlock");
    ...
    public IEnumerator Spawn(GameObject cell)
    {
        ...
        var tower = (GameObject)Object.Instantiate(_ShockTowerBlockPrefab, pos, rotation, _holder);
